...
for position, line in enumerate(bf):
    if (position) > min_row and (position) <= max_row:
        ...
        if url == 'https://pubmed.ncbi.nlm.nih.gov/?term=10.1128/IAI.74.2.1148-1155.2006':
                school = 'University of Texas Medical Branch'
                dep = 'Department of Pediatrics'
        else:
