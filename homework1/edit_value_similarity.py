...
def computeScores(fileInput, outCSV, acceptTypes, allKeys):
    ...
    with open(outCSV, "w") as outF:
        ...
        for root, dirnames, files in os.walk(fileInput):
...
if __name__ == "__main__":
    ...
    elif args.fileInput and args.outCSV:
        computeScores(args.fileInput, args.outCSV, args.accept, args.allKeys)
    else:
        if args.json:
